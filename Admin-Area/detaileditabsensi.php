...
<head>
  ...
  <title>Edit Absensi | Absensi Mahasiswa</title>
...
<body id="page-top">
  ...
  <form role="form" action="editabsensi.php?npm=<?php echo $npm;?>" method="post" name="postform" enctype="multipart/form-data">
    <div class="col-md-6">                
      <div class="card shadow mb-4">
        ...
        <div class="card-body">             
          <div class="table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      <label class="radio-inline">
                        <input type="radio" name="<?php echo $npm; ?>" id="<?php echo 'opsi1'.$kehadiran; ?>" <?php if ($kehadiran=="Hadir") {echo "checked";} ?> value="Hadir">Hadir
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="<?php echo $npm; ?>" id="<?php echo 'opsi2'.$kehadiran; ?>" <?php if ($kehadiran=="Sakit") {echo "checked";} ?> value="Sakit">Sakit
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="<?php echo $npm; ?>" id="<?php echo 'opsi3'.$kehadiran; ?>" <?php if ($kehadiran=="Izin") {echo "checked";} ?> value="Izin">Izin
                      </label>

                      <label class="radio-inline">
                        <input type="radio" name="<?php echo $npm; ?>" id="<?php echo 'opsi4'.$kehadiran; ?>" <?php if ($kehadiran=="Alpha") {echo "checked";} ?> value="Alpha">Alpha
                      </label>
                      <label class="radio-inline">
                        <input type="radio" name="<?php echo $npm; ?>" id="<?php echo 'opsi5'.$kehadiran; ?>" <?php if ($kehadiran=="Tidak Hadir") {echo "checked";} ?> value="Tidak Hadir">Tidak Hadir
                      </label>
                    </td>
                  </tr>
                  <?php
                } else {
                  echo "<tr><td colspan='2'>Pengguna dengan NPM tersebut tidak ditemukan.</td></tr>";
                }
            ...
            <?php } ?>
            <a class="btn btn-secondary" href="./lihatabsen.php">Kembali</a>
          </div>
        </div>
      </div>
    </div>
